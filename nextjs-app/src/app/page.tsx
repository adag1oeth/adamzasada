            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                ...
                <ContactButton
                  ...
                  icon={
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M21.5 0h-19C1.12 0 0 1.12 0 2.5v19C0 22.88 1.12 24 2.5 24h19c1.38 0 2.5-1.12 2.5-2.5v-19C24 1.12 22.88 0 21.5 0zM7.5 5.5h9c.83 0 1.5.67 1.5 1.5v10c0 .83-.67 1.5-1.5 1.5h-9c-.83 0-1.5-.67-1.5-1.5V7c0-.83.67-1.5 1.5-1.5zm4.5 10.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0-5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z"/>
                    </svg>
                  }
                  text="Farcaster"
                  variant="secondary"
              ...
              <div className="flex gap-6 justify-center">
                {[
                  ...
                  { href: "https://farcaster.xyz/adag1o.eth", icon: "farcaster", label: "Farcaster" }
                ].map(({ href, icon, label }) => (
                  <a 
                    key={icon}
                    href={href}
                    ...
                    aria-label={label}
                    onClick={() => trackContactClick({ contact_method: icon as 'github' | 'linkedin' | 'medium' | 'farcaster', contact_location: 'footer_social' })}
                  >
                    <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      {icon === 'farcaster' && <path d="M21.5 0h-19C1.12 0 0 1.12 0 2.5v19C0 22.88 1.12 24 2.5 24h19c1.38 0 2.5-1.12 2.5-2.5v-19C24 1.12 22.88 0 21.5 0zM7.5 5.5h9c.83 0 1.5.67 1.5 1.5v10c0 .83-.67 1.5-1.5 1.5h-9c-.83 0-1.5-.67-1.5-1.5V7c0-.83.67-1.5 1.5-1.5zm4.5 10.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm0-5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z"/>}
                    </svg>
                  </a>
                ))}
              </div>
